...
///  <summary> Looks up a localized string similar to Accept. </summary>
...
///  <summary> Looks up a localized string similar to NOTE: All switches are case-sensitive.  The contents of the switches aren&apos;t unless otherwise noted.. </summary>
...
///  <summary> Looks up a localized string similar to application/octet-stream. </summary>
...
///  <summary> Looks up a localized string similar to The asset &apos;{0}&apos; has been accepted by GitHub.. </summary>
...
///  <summary> Looks up a localized string similar to assets.zip. </summary>
...
///  <summary> Looks up a localized string similar to $The asset compression process has resulted in a package that has zero size.. </summary>
...
///  <summary> Looks up a localized string similar to Authorization. </summary>
...
///  <summary> Looks up a localized string similar to --body. </summary>
...
///  <summary> Looks up a localized string similar to --body: Text body for the release (optional).. </summary>
...
///  <summary> Looks up a localized string similar to cache-control. </summary>
...
///  <summary> Looks up a localized string similar to Content-Type. </summary>
...
///  <summary> Looks up a localized string similar to https://api.github.com/repos/{0}/{1}/releases. </summary>
...
///  <summary> Looks up a localized string similar to Default target branch is &apos;master&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to The directory &apos;{0}&apos; could not be located.. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -108. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -107. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -106. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -104. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -105. </summary>
...
///  <summary> Looks up a localized string similar to {0}\n\t{1}. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to 0. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -103. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -101. </summary>
...
///  <summary> Looks up a localized resource of type System.Int32 similar to -102. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Failed to format the JSON of the create-release request body.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Failed to initialize log file.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Could not package release for posting.. </summary>
...
///  <summary> Looks up a localized string similar to Failed to upload asset &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Unable to zip the assets in folder &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Failed to validate release metadata.. </summary>
...
///  <summary> Looks up a localized string similar to application/vnd.github.v3.raw. </summary>
...
///  <summary> Looks up a localized string similar to token {0}. </summary>
...
///  <summary> Looks up a localized string similar to 0.7.3. </summary>
...
///  <summary> Looks up a localized string similar to github-release-poster by xyLOGIX. </summary>
...
///  <summary> Looks up a localized string similar to 0.7.4. </summary>
...
///  <summary> Looks up a localized string similar to --is-draft. </summary>
...
///  <summary> Looks up a localized string similar to --is-draft: Specify this switch to mark this release as a draft.  Leave this switch off to not do so.. </summary>
...
///  <summary> Looks up a localized string similar to --is-pre-release. </summary>
...
///  <summary> Looks up a localized string similar to --is-pre-release: Specify this switch to mark this release as pre-release; leave it off to not do so.. </summary>
...
///  <summary> Looks up a localized string similar to The release asset folder &apos;{0}&apos; has been located.. </summary>
...
///  <summary> Looks up a localized string similar to master. </summary>
...
///  <summary> Looks up a localized string similar to --name: String containing the name of this release.  Surround with quotes if it contains spaces.. </summary>
...
///  <summary> Looks up a localized string similar to --no-zip. </summary>
...
///  <summary> Looks up a localized string similar to --no-zip: Specify this flag on the command line to turn off the automatic ZIPping of release assets.. </summary>
...
///  <summary> Looks up a localized string similar to no-cache. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: No files found in the destination that were suitable for ZIPping.. </summary>
...
///  <summary> Looks up a localized string similar to This release&apos;s assets will NOT be zipped up prior to upload.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: No output path specified for the release asset ZIP file.. </summary>
...
///  <summary> Looks up a localized string similar to Posting release &apos;{0}&apos; to repository &apos;{1}&apos;.... </summary>
...
///  <summary> Looks up a localized string similar to The GitHubReleasePoster.PostNewRelease method did not succeed.. </summary>
...
///  <summary> Looks up a localized string similar to Processing release assets.... </summary>
...
///  <summary> Looks up a localized string similar to github-release-poster. </summary>
...
///  <summary> Looks up a localized string similar to --release-asset-dir. </summary>
...
///  <summary> Looks up a localized string similar to --release-asset-dir: Path to directory containing the assets for this release.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: The release asset directory path, &apos;{0}&apos;, contains characters that Windows does not allow to be present in a file or directory name.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: The release asset directory or one of its subfolders contains a file that is 2 GB or greater in size.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: The release asset directory &apos;{0}&apos; could not be located.  Please check whether the directory exists.. </summary>
...
///  <summary> Looks up a localized string similar to The release metadata and assets are valid.. </summary>
...
///  <summary> Looks up a localized string similar to Release assets come from folder &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Release &apos;{0}&apos; and its assets have been posted to GitHub.. </summary>
...
///  <summary> Looks up a localized string similar to This release is being marked as Draft.. </summary>
...
///  <summary> Looks up a localized string similar to This release is being marked as Pre-Release.. </summary>
...
///  <summary> Looks up a localized string similar to This release is NOT being marked as Draft.. </summary>
...
///  <summary> Looks up a localized string similar to This release is NOT being marked as Pre-Release.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: The name of the destination ZIP file &apos;{0}&apos;  for the release assets contains invalid characters.. </summary>
...
///  <summary> Looks up a localized string similar to --repo-name. </summary>
...
///  <summary> Looks up a localized string similar to --repo-name &lt;name&gt;: Name of the GitHub repository to which the release should be posted.. </summary>
...
///  <summary> Looks up a localized string similar to --repo-owner. </summary>
...
///  <summary> Looks up a localized string similar to --repo-owner: GitHub username of the owner of the repository to which the release should be posted.. </summary>
...
///  <summary> Looks up a localized string similar to Sending HTTP POST request to create release &apos;{0}&apos;.... </summary>
...
///  <summary> Looks up a localized string similar to The switch &apos;{0}&apos; is required.. </summary>
...
///  <summary> Looks up a localized string similar to --tag-name. </summary>
...
///  <summary> Looks up a localized string similar to --tag-name: GitHub tag to associate this release with.. </summary>
...
///  <summary> Looks up a localized string similar to --target-branch. </summary>
...
///  <summary> Looks up a localized string similar to --target-branch: GitHub branch to target this release from.. </summary>
...
///  <summary> Looks up a localized string similar to C:\Users\ENS Brian Hart\Dropbox\Downloads\emu8086. </summary>
...
///  <summary> Looks up a localized string similar to NetworkKeeper. </summary>
...
///  <summary> Looks up a localized string similar to astrohart. </summary>
...
///  <summary> Looks up a localized resource of type System.UInt64 similar to 2147483648. </summary>
...
///  <summary> Looks up a localized string similar to undefined. </summary>
...
///  <summary> Looks up a localized string similar to {0}?name={1}&amp;label={2}. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Unable to get upload_url value from create release response.. </summary>
...
///  <summary> Looks up a localized string similar to Usage:. </summary>
...
///  <summary> Looks up a localized string similar to --user-access-token. </summary>
...
///  <summary> Looks up a localized string similar to --user-access-token: String specifying the user access token to use with GitHub API.. </summary>
...
///  <summary> Looks up a localized string similar to User-Agent. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Current user does not have access permissions to folder &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Release body is: {0}. </summary>
...
///  <summary> Looks up a localized string similar to Release name is &apos;{0}&apos;. </summary>
...
///  <summary> Looks up a localized string similar to Using repo-name &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Using repo-owner &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Using release tag &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Using target branch &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Using user access token &apos;{0}&apos;.. </summary>
...
///  <summary> Looks up a localized string similar to Validating release metadata.... </summary>
...
///  <summary> Looks up a localized string similar to --version: This switch displays this program&apos;s name and version number, along with a copyright message.  If specified, the --version switch must appear by itself.. </summary>
...
///  <summary> Looks up a localized string similar to application/zip. </summary>
...
///  <summary> Looks up a localized string similar to The size of the &apos;{0}&apos; file is 2 GB or more in size.  GitHub won&apos;t accept it.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: The output ZIP file for the release assets may not be in the same folder as the assets themselves.. </summary>
...
///  <summary> Looks up a localized string similar to ERROR: Blank value supplied for ZIP file output folder path. Stopping.. </summary>
...
///  <summary> Looks up a localized string similar to This release&apos;s assets will be placed in a ZIP file prior to upload.. </summary>
