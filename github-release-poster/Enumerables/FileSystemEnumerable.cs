...
namespace GitHubReleasePoster.Enumerables
{
    ...
    public class FileSystemEnumerable : IEnumerable<FileSystemInfo>
    {
        ...
        ///<summary>
        /// Constructs a new instance of <see cref="T:GitHubReleasePoster.Enumerables.FileSystemEnumerable"/> and returns a reference to it.
        ///</summary>
        ...
        public IEnumerator<FileSystemInfo> GetEnumerator()
        {
            ...
            catch (IOException e)
            {
                ...
                //_logger.Warn($@"Could not process path (check SymlinkEvaluation rules)'{_root.Parent?.FullName}\{_root.Name}'.", e);
                yield break;
            }
            catch
            {
                // All other exceptions -- just skip it
                //_logger.Warn(@"Caught an unknown exception.  Perhaps we have stumbled upon a file or directory which is protected by the operating system.");
                yield break;
            }
