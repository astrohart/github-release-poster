...
{
    /// <summary> Encapsulates the command-line parameters of this app. </summary>
    public class CommandLineInfo
    {
        /// <summary>
        /// Holds an reference to the one and only instance of
        /// <see cref="T:github_release_poster.CommandLineInfo" />.
        /// </summary>
        private static CommandLineInfo _theCommandLineInfo;

        /// <summary>
        /// Constructs a new instance of
        /// <see cref="T:github_release_poster.CommandLineInfo" /> and returns a reference
        /// to it.
        /// </summary>
        /// <remarks>
        ...
        /// <see cref="T:github_release_poster.CommandLineInfo" />.
        /// </summary>
        public static CommandLineInfo Instance
            => _theCommandLineInfo ??
        ...
        /// </summary>
        /// <remarks>
        /// If this flag is true, do not compress the assets.  Otherwise, compress
        /// them in a ZIP format file before uploading to the release. The user must
        ...
        public void Clear()
        {
            ...
            ShouldNotZip =
                false; /* zip the release assets prior to uploading by default */
        }

        /// <summary>
        /// Parses this application's command line and sets the properties of
        /// this object accordingly.
        /// </summary>
        /// <param name="args">
        /// Reference to an instance of an array of strings that
        /// contains the application's command-line arguments.
        /// </param>
        public bool ParseCommandLine(string[] args)
        {
            ...
            if (args.Length == 1 && args.Contains("--version"))
            {
            ...
            if (!isError && !string.IsNullOrWhiteSpace(Body))
                Console.WriteLine(
                    Resources.UsingReleaseBody, Body.Replace("\n", string.Empty)
            ...
            ReleaseAssetDir = GetSwitchValue(
                args, Resources.RELEASE_ASSET_DIR_SWITCH
            );
            ...
            else if (!isError)
            {
                ...
                {
                    Console.WriteLine(
                        Resources.ReleaseAssetsComeFromFolder, ReleaseAssetDir
                    );
                }
                else
                {
                    Console.WriteLine(
                        Resources.SwitchRequired,
                        Resources.RELEASE_ASSET_DIR_SWITCH
                    );
                    isError = true;
                }
            }
            ...
            {
                Console.WriteLine(
                    Resources.LocatedReleaseAssetDirSuccessfully,
                    ReleaseAssetDir
                );
            }
            ...
            TargetBranch = GetSwitchValue(
                args, Resources.TARGET_BRANCH_SWITCH, TargetBranch
            );
            ...
            UserAccessToken = GetSwitchValue(
                args, Resources.USER_ACCESS_TOKEN_SWITCH
            );
            ...
            {
                Console.WriteLine(
                    Resources.UsingUserAccessToken, UserAccessToken
                );
            }
        ...
        /// <summary>
        /// Gets the value of a command-line switch that has a parameter value
        /// following it.
        /// </summary>
        /// <param name="args">
        /// Reference to a collection of the command-line arguments
        /// passed to this application.
        /// </param>
        /// <param name="switchName">String containing the name of the switch (required.)</param>
        /// <param name="defaultValue">
        /// Default value, if applicable, to use if the switch
        ...
        )
        {
            ...
            try
            {
                var switchIndex = args.ToList()
                                      .FindIndex(switchName.Equals);
                return switchIndex >= 0 && !args[switchIndex + 1]
                    .StartsWith("--")
                    ? args[switchIndex + 1]
                    : defaultValue;
            }
