...
{
    /// <summary> Validates releases. </summary>
    public static class GitHubReleaseValidator
    {
        /// <summary> Validates the release specified. </summary>
        /// <param name="release">
        /// Reference to an instance of
        /// <see cref="github_release_poster.NewRelease" /> that contains the metadata for
        /// the release.
        /// </param>
        /// <param name="repoName">
        /// String containing the name of the repository to which
        /// this release is to be published.
        /// </param>
        /// <param name="repoOwner">
        /// String containing the GitHub username of the owner of
        /// the repository.
        /// </param>
        /// <param name="userAcessToken">
        /// String containing the user access token of a
        /// GitHub user with push access to the repository.
        /// </param>
        /// <param name="releaseAssetDir">
        /// String containing the path to the directory where
        /// release assets are stored.
        /// </param>
        /// <returns>
        /// True if the release is valid; false otherwise.  Terminates the program
        /// with a nonzero exit code if the release does not pass validation.
        /// </returns>
        /// <exception cref="T:System.ArgumentNullException">
        /// Thrown if the
        /// <see cref="release" /> argument is a null reference of if any of the string
        /// arguments are blank.
        /// </exception>
        public static bool IsReleaseValid(
            NewRelease release,
            string repoName,
            string repoOwner,
        ...
        )
        {
            ...
            if (string.IsNullOrWhiteSpace(release.target_commitish))
                throw new ArgumentNullException(
                    nameof(release.target_commitish)
                );
            ...
            if (!Directory.Exists(releaseAssetDir))
            {
                ...
                Environment.Exit(Resources.ERROR_RELEASE_ASSET_DIR_NOT_EXISTS);
            }
