...
namespace github_release_poster_tests
{
    ...
    {
        /// <summary>
        /// Put your user access token that is used with GitHub here, for
        /// testing.  If there is a token here, it has most likely already been revoked, so
        /// don't think you can use it.
        /// </summary>
        private const string MyUserAccessToken = "<your-user-token-here>";

        /// <summary>
        /// Tests the GitHubReleasePoster class, and it tells it to zip up the
        /// assets before uploading.
        /// </summary>
        /// <remarks> Zipping the ass </remarks>
        [Test]
        public void PostNewReleaseWithNoZip()
        {
            ...
            var result = GitHubReleasePoster.PostNewRelease(
                Resources.TestingRepoName, Resources.TestingRepoOwner,
                MyUserAccessToken, Resources.TestingAssetsSourceDirPath,
                NewReleaseFactory.CreateNewRelease(
                    string
                        .Empty, /* Pass in something different to test the body */
                    true, /* make this release a draft, so that it does not interrupt any release trains */
                    Resources.GitHubIndivAssetTestingReleaseName, false,
            ...
            var result = GitHubReleasePoster.PostNewRelease(
                ...
                NewReleaseFactory.CreateNewRelease(
                    string
                        .Empty, /* Pass in something different to test the body */
                    true, /* make this release a draft, so that it does not interrupt any release trains */
                    Resources.GitHubZipAssetsTestingReleaseName, false,
