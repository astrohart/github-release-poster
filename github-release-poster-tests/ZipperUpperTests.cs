...
namespace github_release_poster_tests
{
    ...
    {
        /// <summary>
        /// Fake, gibberish file/directory path
        /// </summary>
        ...
        /// a GUID in a subfolder of the user's Desktop folder that is itself also named after a GUID.
        /// </summary>
        ...
        /// <summary>
        /// Test to ensure the <see cref="T:github_release_poster.ZipperUpper"/> class refuses to compress
        /// a folder when the folder name is valid but the destination ZIP file path is gibberish.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test to ensure the <see cref="T:github_release_poster.ZipperUpper"/> class refuses to run when
        /// a blank or invalid directory has been passed.
        /// </summary>
        [Test]
